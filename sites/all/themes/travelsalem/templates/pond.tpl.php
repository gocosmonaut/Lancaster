...
<div class="panel-display pond clearfix <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="pond-container pond-sandwich clearfix panel-panel">
    <div class="pond-container-inner pond-sandwich-inner panel-panel-inner">
      <?php print $content['sandwich']; ?>
    </div>
  </div>    
